export const healthUnitSeeds = [
  ...
  {
    nome: 'UBS Jardim Norte',
    type: 'PRIMARY_CARE',
    addressStreet: 'Rua das Flores, 45',
    addressCity: 'Sao Paulo',
    addressState: 'SP',
    addressZip: '02000-000',
    locationLat: -23.5301,
    locationLng: -46.6202,
  ...
  {
    nome: 'Hospital Municipal Leste',
    type: 'ACUTE_CARE',
    addressStreet: 'Rua Primavera, 300',
    addressCity: 'Sao Paulo',
    addressState: 'SP',
    addressZip: '03000-000',
    locationLat: -23.5612,
    locationLng: -46.5211,
    services: 'emergencia,internacao,cirurgia',
    phone: '(11) 3000-3000',
    openingHours: '24h'
  }
];
